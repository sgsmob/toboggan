...
"""
this code will take in 1 file containing a list of instances,
for each run catfish and toboggan look at the path outputs
"""
    ...
    with open(tob_results, 'r') as reader:
        for line in reader:
            if line.startswith("#") and "Solutions:" in line:
                paths_found = True
            elif paths_found is True and '[' in line:
