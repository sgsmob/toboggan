...
def main(args):
    ...
    timeout_file = args.timeouts_list
    ...
    print("{} timed out graphs written to {}".format(
        len(timed_out_graphs), timeout_file))

    # plot runtime (time_weights + time_paths) as a function of # edges ;
    # as a function of k_optimal
    total_times = []
    finished_times = []
    finished_opt = []
    finished_densities = []
    ...
    print("(3) Number of non-trivial, non-timeouts is {},"
          " ave runtime is {}".format(div, nontt_times/div))
    ...
    print("(4) Distribution of gaps between lower_bound and k_optimal"
          "(gap-size: frequency):")
    print(Counter(gaps))
    print("Distribution of gaps between cutset and k_optimal (gap-size:"
          " frequency):")
...
if __name__ == "__main__":
    ...
    parser.add_argument("timeouts_list", help="name of file to output list of"
                        " timed out instances in, in a format easy to re-run.",
                        type=str)
